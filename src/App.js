 ...
 scrollTo() {
  ...
  render() {
    return (
      <div className="App">
        <nav>
          <a href="/"><h2 className="dollar">$</h2><h1>tocked</h1></a>
        </nav>
        <div id="wrapper">
          <div id="information-div">
            <h1 id="header">$tocked</h1>
            <h4 className="header-text">Keep track of your favorite $tocks with ease...</h4>
            <h4 className="header-text">$tocked Runs on <a href="https://www.alphavantage.co" className="alphavantage-link"><h3 className="alpha">ALPHA</h3> <h3 className="vantage">VANTAGE's</h3></a> free API to provide you with current information including open, close, and max and min values.</h4>
